...
public class Register_bak extends Activity{
	...
	private class LogListener implements OnClickListener{
		...
		public void onClick(View v) {
			...
			intent.setClass(Register_bak.this,LoginActivity.class );
  ...
  private class RigsterListener implements OnClickListener{
	...
	public void onClick(View v) {
		...
		if(!validate){
			intent.setClass(Register_bak.this,MessageActivity.class);
			startActivity(intent);
			return;
		}else {
			...
			//保存到数据库
			Dyc_DBHelper dbhelper=new Dyc_DBHelper(Register_bak.this );
			//验证用户是否存在？
